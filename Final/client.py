...
import subprocess  # Для запуска внешнего скрипта (clientftp.py)
...
def sendPhoto():
    """Функция для отправки фотографии, вызывается при нажатии кнопки."""
    try:
        # Запуск внешнего скрипта clientftp.py для отправки фотографии
